  ...
  methods: {
    initDiagram() {
      ...
      const linkDataArray = [
        ...
        { from: 'ROUTER-VPN1', to: 'LEAF-01-BOTTOM', label: 'Gi0/0/2 OUTSIDE E1/41' },
        { from: 'ROUTER-VPN1', to: 'LEAF-02-BOTTOM', label: 'Gi0/0/3 E1/43' },
        { from: 'ROUTER-VPN2', to: 'LEAF-01-BOTTOM', label: 'Gi0/0/2 OUTSIDE E1/41' },
        { from: 'ROUTER-VPN2', to: 'LEAF-02-BOTTOM', label: 'Gi0/0/3 E1/43' },
      ]
