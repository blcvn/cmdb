const cmdb_zh = {
    ...
    relation_type: {
        ...
        nameTips: '请输入类型名',
        description: '描述',
        descriptionPlaceholder: '描述这个连接是什么',
        firstToSecondImpact: '影响 (第一个 → 第二个)',
        secondToFirstImpact: '影响 (第二个 → 第一个)',
        impactNone: '无',
        impactLow: '低',
        impactMedium: '中',
        impactHigh: '高',
        impactCritical: '严重',
        functionDescription: '关系类型功能说明',
        functionDetail: '关系类型定义CI之间的连接关系，包括：名称、描述（这个连接是什么）、以及双向影响级别（从第一个CI到第二个CI的影响，以及从第二个CI到第一个CI的影响）。',
        impactScale: '影响等级',
        points: '分',
    },
    ad: {
