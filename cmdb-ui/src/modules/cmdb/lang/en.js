const cmdb_en = {
    ...
    relation_type: {
        ...
        descriptionPlaceholder: 'Describe what this connection is',
        firstToSecondImpact: 'Impact (First → Second)',
        secondToFirstImpact: 'Impact (Second → First)',
        impactNone: 'None',
        impactLow: 'Low',
        impactMedium: 'Medium',
        impactHigh: 'High',
        impactCritical: 'Critical',
        functionDescription: 'Relationship Type Function',
        functionDetail: 'Relationship Type defines the connection between CIs, including: Name, Description (what this connection is), and Impact levels in both directions (from first CI to second CI, and from second CI to first CI).',
        impactScale: 'Impact Scale',
        points: 'points',
    },
    ad: {
        upload: 'Import',
